...
public abstract class Constants<F extends Field<F>> {
     ...
     */
    public static final Scalar pi = Expressions.take(Units.PI);
    
    /**
     * The base of natural logarithms, <i>e</i>, defined as 2.718 281 828 459 045 235 360 287 471 352.
     */
    public static final Scalar euler =  Expressions.take(Units.E);
    
    /**
     * The speed of light in a vacuum, <i>c</i>, defined as 299 792 458 {@link Units#METER_PER_SECOND meters per second}.
     */
    public static final Expression c = Expressions.take("299792458",Units.METER_PER_SECOND);
    
    /**
     * The Planck constant, <i>h</i>, defined as 
     * 6.626 070 15 × 10<sup>−34</sup> {@link Units#JOULE joule}⋅{@link Units#SECOND second}.
     */
    public static final Expression h = Expressions.take("6.62607015E−34", Units.newUnit().as(Units.JOULE).multiply(Units.SECOND).create());
     ...
     */
    public static final Expression G = Expressions.take("6.67430E−11", Units.newUnit().as(Units.METER,3).divide(Units.KILOGRAM).divide(Units.SECOND,2).create());
     ...
     */
    public static final Expression eps_0 = Expressions.take("8.8541878128E−12", Units.newUnit().as(Units.FARAD).divide(Units.METER).create());
     ...
     */
    public static final Expression mu_0 = Expressions.take("1.25663706212E−6", Units.newUnit().as(Units.HENRY).divide(Units.METER).create());
     ...
     * {@link Units#OHM ohm}.
     */
    public static final Expression Z_0 = Expressions.take("376.730313668",Units.OHM);
     ...
     */
    public static final Expression e = Expressions.take("1.602176634E−19",Units.COULOMB);
     ...
     */
    public static final Expression Dnu_Cs = Expressions.take("9192631770",Units.HERTZ);
     ...
     */
    public static final Expression N_A = Expressions.take("6.02214076E23",Units.newUnit().as(Units.MOLE,-1).create());
     ...
     */
    public static final Expression k_B = Expressions.take("1.380649E−23",Units.newUnit().as(Units.JOULE).divide(Units.KELVIN).create());
    
    /**
     * The Josephson constant, <i>K<sub>J</sub></i>, defined as
     * 2⋅{@link #e e} / {@link #h h}.
     */
    public static final Expression K_J = Expressions.take(2).multiply(e).divide(h);
     ...
     */
    public static final Expression alpha = Expressions.take("7.2973525693E−3",Units.UNITLESS);
    
    /**
     * The Bohr radius, <i>a<sub>0</sub></i>, defined as
     * 5.291 772 109 03 × 10<sup>−11</sup> {@link Units#METER meter}.
     */
    public static final Expression a_0 = Expressions.take("5.29177210903E−11",Units.METER);
    
    /**
     * The classical electron radius, <i>r<sub>e</sub></i>, defined as
     * 2.817 940 326 2 × 10<sup>−15</sup> {@link Units#METER meter}.
     */
    public static final Expression r_e = Expressions.take("2.8179403262E−15",Units.METER);
    
    /**
     * The electron g-factor, <i>g<sub>e</sub></i>, defined as
     * −2.002 319 304 362 56 {@link Units#UNITLESS -}.
     */
    public static final Expression g_e = Expressions.take("−2.00231930436256",Units.UNITLESS);
    
    /**
     * The Hartree energy, <i>E<sub>h</sub></i>, defined as
     * 4.359 744 722 207 1 × 10<sup>−18</sup> {@link Units#JOULE joule}.
     */
    public static final Expression E_h = Expressions.take("4.3597447222071E−18",Units.JOULE);
    
    /**
     * The Rydberg constant, <i>R<sub>\u221E</sub></i>, defined as
     * 10 973 731.568 160 {@link Units#METER meter}<sup>−1</sup>.
     */
    public static final Expression R_inf = Expressions.take("10973731.568160",Units.newUnit().as(Units.METER,-1).create());
     ...
     */
    public static final Expression sigma_e = Expressions.take("6.6524587321E−29",Units.SQUARE_METER);
     ...
     */
    public static final Expression M_u = Expressions.take("0.99999999965E−3",Units.newUnit().as(Units.KILOGRAM).divide(Units.MOLE).create());
     ...
     */
    public static final Expression sigma = pi.multiply(pi)
            .multiply(k_B).multiply(k_B).multiply(k_B).multiply(k_B)
            .divide(Expressions.take(60)
